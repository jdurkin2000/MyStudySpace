      ...
      <div className="flex flex-col items-center gap-8 p-15">
          ...
          <section className="w-200 p-10">
            <p className="bg-[#e3722b]/50 rounded p-10 text-2xl font-sans">
              With our cutting edge widgets to personalize your StudySpace^TM, you can create a virtual environment
              that suits your unique study style. Whether you need a timer, a note-taking tool, or a distraction blocker,
              our widgets have you covered.
            </p>
        </section>
      </div>
        {/* Main Section */}
        <h1 className="text-7xl font-mono self-center">Make <b>your</b> StudySpace</h1>
        <div className="p-8 flex flex-1 flex-col md:flex-row gap-8 justify-center items-center relative z-10">
          ...
          <section className="w-200 flex flex-col gap-6 text-[#0d0502] p-5">
            <div>
              <h2 className="font-mono mb-2 text-3xl font-medium">Tailor Your Study Sessions</h2>
              <p className="p-3 bg-[#7dee90]/75 rounded font-sans text-2xl">
                Customize your workspace with widgets built to boost your focus.
              </p>
            </div>
            <div>
              <h2 className="mb-2 font-mono text-3xl font-medium">Tired of Juggling Tabs?</h2>
              <p className="p-3 bg-[#7dee90]/75 rounded font-sans text-2xl">
                Find everything you need in one place, powered by smart tools.
              </p>
            </div>
            <div>
              <h2 className="mb-2 font-mono text-3xl font-medium">Zero Ads, Zero Distractions</h2>
              <p className="p-3 bg-[#7dee90]/75 rounded font-sans text-2xl">
                We’re built for <b>students</b>, not ad revenue — goodbye Quizlet
                clutter.
              </p>
            </div>
          </section>
